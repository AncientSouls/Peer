[ancient-peer](../README.md) > ["peer"](../modules/_peer_.md) > [IPeer](../interfaces/_peer_.ipeer.md)
...
## Type parameters
#### IEventsList :  [IPeerEventsList](_peer_.ipeereventslist.md)
## Hierarchy
...
**●  relations**:  *[IPeerRelationsChannels](_peer_.ipeerrelationschannels.md)* 
...
► **gotPkg**(channelId: *`string`*, pkg: *[IPeerPkg](_peer_.ipeerpkg.md)*): `void`
...
| ------ | ------ | ------ |
| channelId | `string`   |  - |
| pkg | [IPeerPkg](_peer_.ipeerpkg.md)   |  - |
...
► **handleBundles**(channelId: *`string`*, pkg: *[IPeerPkg](_peer_.ipeerpkg.md)*): `void`
...
► **handleDestroyed**(channelId: *`string`*, pkg: *[IPeerPkg](_peer_.ipeerpkg.md)*): `void`
...
► **handleQueries**(channelId: *`string`*, pkg: *[IPeerPkg](_peer_.ipeerpkg.md)*): `void`
