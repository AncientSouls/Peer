[ancient-peer](../README.md) > ["peer"](../modules/_peer_.md) > [IPeerCursor](../interfaces/_peer_.ipeercursor.md)
...
**●  query**:  *[TPeerApiQuery](../modules/_peer_.md#tpeerapiquery)* 

*Defined in [peer.ts:48](https://github.com/AncientSouls/Peer/blob/e61cf1a/src/lib/peer.ts#L48)*
...
► **exec**(query: *[IPeerCursorQuery](_peer_.ipeercursorquery.md)*, data?: *`any`*): `void`



*Defined in [peer.ts:49](https://github.com/AncientSouls/Peer/blob/e61cf1a/src/lib/peer.ts#L49)*
...
| Param | Type | Description |
| ------ | ------ | ------ |
| query | [IPeerCursorQuery](_peer_.ipeercursorquery.md)   |  - |
| data | `any`   |  - |
